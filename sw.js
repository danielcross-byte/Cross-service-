const CACHE='cross-service-v39-separate-images';
const CORE=['./','./index.html','./manifest.json','./bike_highres_crop.png'];
const DETAIL=['gear','airfilter','chain','frontbrake','tire','spark','carb','piston','exhaust','cooling','suspension','steering'].map(x=>`./service_images/${x}.jpg`);
